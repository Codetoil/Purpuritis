package io.codetoil.dynamic_registries.data;
...
public record DataProviderDynamicRegistries<O>(PackOutput output,
    ...
    public @NotNull CompletableFuture<?> run(@NotNull CachedOutput cachedOutput) {
        ...
        return this.registries.thenCompose(provider -> {
            Purpuritis.LOGGER.info("Starting the generation for {}", dynamicRegistriesObjectHelper.getId());
            ...
            Purpuritis.LOGGER.info("Finished generating {}", dynamicRegistriesObjectHelper.getId());
