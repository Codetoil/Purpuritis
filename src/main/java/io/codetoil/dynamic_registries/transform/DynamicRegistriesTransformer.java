package io.codetoil.dynamic_registries.transform;
...
public record DynamicRegistriesTransformer<T>(Predicate<String> isTopLevelParent) implements ITransformer<T> {
