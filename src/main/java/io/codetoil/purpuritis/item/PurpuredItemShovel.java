...
public class PurpuredItemShovel extends ToolItem implements IPurpuredItem
{
	public ToolItem normalItem;

	public PurpuredItemShovel(ToolItem normalItem, PurpuredTier tier, float additonalAttackDamage, float attackSpeed, Set<Block> effectiveBlocks, Properties properties)
	{
		super((int) additonalAttackDamage, attackSpeed, tier, effectiveBlocks, properties);
