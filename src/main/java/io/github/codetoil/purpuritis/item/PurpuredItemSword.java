...
public class PurpuredItemSword extends SwordItem implements IPurpuredItem
{
	public Item normalItem;

	public PurpuredItemSword(Item normalItem, PurpuredTier tier, float additionalAttackDamage, float attackSpeed, Properties properties)
	{
		super(tier, (int) additionalAttackDamage, attackSpeed, properties);
