...
public class PurpuredItemPickaxe extends PickaxeItem implements IPurpuredItem
{
	public ToolItem normalItem;

	public PurpuredItemPickaxe(ToolItem normalItem, PurpuredTier tier, float additonalAttackDamage, float attackSpeed, Set<Block> effectiveBlocks, Properties properties)
	{
